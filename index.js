...
// 🎯 ৫০টি হাই-ভলিউম কয়েন পুল (স্লট ফাঁকা থাকবে না)
const COINS = [
    ...
    { s: "LTCUSDT", n: "LTC", d: 2, qd: 3 }, { s: "BCHUSDT", n: "BCH", d: 2, qd: 3 }
];
        ...
        for (let userId in allUsers) {
            ...
            slots.forEach(async (sl) => {
                ...
                if (sl.status === 'BOUGHT') {
                    ...
                    // প্রফিট এক্সিট (ফি বাদ দিয়ে নিট লাভ গ্যারান্টি)
                    const gain = (sl.qty * s.p) - (sl.qty * sl.buy) - (sl.qty * s.p * 0.0008);
                    if ((s.p >= sl.sell || sl.pnl >= 4.0) && gain >= 0.01) {
