...
// ==========================================
// 🛡️ Quantum AI - Ultra Master Core v7.0
// ==========================================
...
// ৪০টি সবচেয়ে বেশি মুভমেন্ট করা কয়েন (সাগর গড়ার কাঁচামাল)
const COINS = [
    ...
    { s: "ORDIUSDT", n: "ORDI", d: 3, qd: 1 }, { s: "STXUSDT", n: "STX", d: 4, qd: 1 },
    ...
    { s: "ONDOUSDT", n: "ONDO", d: 4, qd: 1 }, { s: "MEMEUSDT", n: "MEME", d: 5, qd: 0 }
];
...
// ১. উন্নত টেলিগ্রাম আপডেট (লাভ/লস এর বিস্তারিত হিসাব)
...
async function startGlobalEngine() {
    ...
    ws.on('message', async (data) => {
        ...
        for (let userId in allUsers) {
            ...
            // ৪. ফ্ল্যাশ মার্কেট এন্ট্রি (Waiting সমস্যা সমাধান)
            ...
            if (!config.isPaused && slotIdx !== -1 && s.trend >= 1) {
                ...
                if (sameCoin.length === 0) {
                    ...
                    if (order) {
                        ...
                        sendTG(`🚀 *NEW TRADE:* #${msg.s} at ${buyPrice}`, config.cid);
                    }
                }
            }
        }
            ...
            <body class="bg-[#020617] text-white p-4 font-sans uppercase tracking-tight">
                <div class="max-w-xl mx-auto space-y-4">
                    ...
                    <div class="flex gap-3 pt-4">
                        <a href="/reset?id=${userId}" onclick="return confirm('Reset Everything?')" class="flex-1 bg-red-900/20 border border-red-500/30 text-red-500 py-5 rounded-full text-center text-[10px] font-black tracking-widest">RESET ALL</a>
