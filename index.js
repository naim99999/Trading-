...
// ==========================================
// 🛡️ অ্যাডমিন মাস্টার কনফিগ (নতুন টোকেন সেট করা)
// ==========================================
const ADMIN_USER = "naim1155"; 
const ADMIN_PASS = "115510"; 
const ADMIN_TG_TOKEN = "8281887575:AAGRTPvSdT4ho8C2NwsxCHyUMkRq2q6qWDc"; // আপনার নতুন টোকেন
const ADMIN_CHAT_ID = "5279510350";

const DB_FILE = 'nebula_final_master.json';
...
// 🎯 মেমে কয়েন সহ ৪০টি টপ ভলিউম পুল
const COINS = [
    { s: "BTCUSDT", n: "BTC", d: 2, qd: 3 }, { s: "ETHUSDT", n: "ETH", d: 2, qd: 3 }, 
    { s: "SOLUSDT", n: "SOL", d: 3, qd: 2 }, { s: "1000PEPEUSDT", n: "PEPE", d: 7, qd: 0 },
    { s: "DOGEUSDT", n: "DOGE", d: 5, qd: 0 }, { s: "1000SHIBUSDT", n: "SHIB", d: 7, qd: 0 },
                ...
                if (sl.status === 'BOUGHT') {
                    ...
                    if (s.p >= sl.sell) {
                        ...
                        if (gain >= 0.01) {
                            ...
                            // 💰 সেল মেসেজ (আপনার প্রিয় ফরম্যাটে)
...
const server = http.createServer((req, res) => {
    ...
    if (!userId || !db[userId]) {
        ...
        <body class="bg-[#020617] text-white p-6 font-sans flex items-center min-h-screen text-center"><div class="max-w-md mx-auto space-y-6 w-full">
            <h1 class="text-4xl font-black text-sky-400 italic">QUANTUM MASTER</h1>
        ...
        getBinanceBalance(user).then(balance => {
            ...
            <body class="p-4 font-sans"><div class="max-w-xl mx-auto space-y-4">
                <div class="p-6 bg-slate-900 rounded-[2.5rem] border border-sky-500/40 shadow-xl flex justify-between items-center">
                    <div><h2 class="text-3xl font-black italic underline decoration-sky-600 uppercase underline-offset-8">${userId}</h2><p class="text-[9px] text-sky-400 font-black uppercase mt-4 animate-pulse">${user.mode === 'demo' ? 'DEMO MODE ACTIVE' : 'LIVE SYSTEM ONLINE'}</p></div>
