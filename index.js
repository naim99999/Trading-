...
// ==========================================
// 🛡️ অ্যাডমিন মাস্টার কনফিগারেশন (Preset)
// ==========================================
...
// 🎯 ৪০টি টপ ভলিউম কয়েন (স্লট কখনো খালি থাকবে না)
const COINS = [
    ...
    { s: "TIAUSDT", n: "TIA", d: 3, qd: 1 }, { s: "XLMUSDT", n: "XLM", d: 5, qd: 0 }, { s: "MATICUSDT", n: "MATIC", d: 4, qd: 0 }
];
                ...
                if (sl.status === 'BOUGHT') {
                    ...
                    if (drop >= 0.40 && sl.dca < 12) {
                        ...
                        if (order) {
                            ...
                            sendTG(`🛡️ *DCA Shield Active!* \nকয়েন: ${sl.sym} (L${sl.dca})`, config.cid);
                        }
                    }
                    if (s.p >= sl.sell) {
