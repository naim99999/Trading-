...
// 🎯 ৫০টি হাই-ভলিউম কয়েন পুল (ক্যাপিটাল ১ সেকেন্ডও বসে থাকবে না)
const COINS = [
    ...
    ws.on('message', async (data) => {
        ...
        for (let userId in allUsers) {
            ...
            slots.forEach(async (sl) => {
                ...
                // ২-মিনিট রিসাইকেল লজিক (স্লট খালি করার জন্য)
            ...
            // ৩. প্রেডিক্টিভ লিমিট এন্ট্রি (স্লট কখনো ফাঁকা থাকবে না)
            const slotIdx = slots.findIndex(sl => !sl.active);
            if (!config.isPaused && slotIdx !== -1 && s.trend >= 2 && s.p <= minP * 1.0005) {
...
// 🌐 মাস্টার ড্যাশবোর্ড UI (অপরিবর্তিত ডিজাইন)
    ...
    if (!userId || !db[userId]) {
        ...
        getBinanceBalance(user).then(balance => {
            ...
            <body class="p-4 font-sans"><div class="max-w-xl mx-auto space-y-4">
                <div class="p-6 bg-slate-900 rounded-[2rem] border border-sky-500/40 shadow-xl shadow-sky-500/10 flex justify-between items-center">
