...
// ==========================================
// 🛡️ Quantum AI - Hyper-Sync Core v62.0
// ==========================================
...
async function sendTG(msg, chatId) {
    ...
    try { await axios.post(`https://api.telegram.org/bot${MASTER_TG_TOKEN}/sendMessage`, { chat_id: id, text: msg, parse_mode: 'HTML' }); } catch (e) {}
}
    ...
    ws.on('message', async (data) => {
        ...
        for (let userId in allUsers) {
            ...
            userSlots[userId].forEach(async (sl) => {
                ...
                // ১. ডায়নামিক ট্রেলিং শিল্ড (লাভের পিছু পিছু দৌড়ানো)
                if (rawPnL >= 0.35) {
                ...
                // ২. অসীম ডিএসিএ লজিক (দাম ১.৫% কমলে এভারেজ)
            ...
            // ৪. হাইপার ডিপ এন্ট্রি (স্লট খালি রাখবে না)
            ...
            if (!config.isPaused && slotIdx !== -1 && s.trend >= 1) {
                ...
                // লজিক: দাম গড়ের নিচে এবং আরএসআই ওভারবট নয় (৪৫ এর নিচে)
                if (s.p < sma && s.rsi < 48) {
                    ...
                    if (sameCoin.length === 0) {
                        ...
                        if (order) {
                            ...
                            sendTG(`🚀 <b>SMART ENTRY:</b> #${msg.s}`, config.cid);
                        }
                    }
                }
            }
